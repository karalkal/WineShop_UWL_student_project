...
<head>
    <title>Wines priced between £50 and £100</title>
...
<p style="font-size: 2.4em; font-style: oblique; text-align: center; color:black;     style="position: absolute;"> 
	<b>Wines priced between £50 and £100</b> </p>
...
<div class="container">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT code, typeID, wineName, typeID, originID, price, picture, available FROM wines WHERE price BETWEEN 50.01 and 100");
	if (!empty($product_array)) { 
		foreach($product_array as $key=>$value){
	?>
		<div class="product-item">
			<form method="post" action="50to100.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
...
<a id="btnEmpty" href="50to100.php?action=empty">Empty Cart</a>
<?php
    ...
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
			...
			<!--	<td><?php echo $item["code"]; ?></td> -->
				...
				<td style="text-align:center;"><a href="50to100.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img style="max-height: 26px; max-width: 26px" src="images/delete_icon.png" alt="Remove Item" /></a></td>
				</tr>
				<?php
